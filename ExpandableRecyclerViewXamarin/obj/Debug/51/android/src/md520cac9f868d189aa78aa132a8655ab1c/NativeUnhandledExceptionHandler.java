...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.InsightsCore.NativeUnhandledExceptionHandler, Xamarin.Insights", NativeUnhandledExceptionHandler.class, __md_methods);
	}


	public NativeUnhandledExceptionHandler ()
	{
		super ();
		if (getClass () == NativeUnhandledExceptionHandler.class)
			mono.android.TypeManager.Activate ("Xamarin.InsightsCore.NativeUnhandledExceptionHandler, Xamarin.Insights", "", this, new java.lang.Object[] {  });
	}
